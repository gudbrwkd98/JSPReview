    ...
    <td align="center" valign="middle" bgcolor="#FFFFCC"> 
      <table border="1" cellspacing="0" cellpadding="2"  align="center">
        <form name="regForm" method="post" action="MemberUpdateProc.jsp">
          ...
          <!--  직접 입력을 받는것이 아니라면 hidden 객체로 전달 -->
          <tr> 
            <td width="16%">아이디 : </td>
            <td width="57%"> <%=mem.getMem_id() %> </td>
            <input type="text" name="mem_id" value="<%=mem.getMem_id() %>" hidden/>
		  ...
		  <tr>  
            <td>직업</td>
            <!-- 콤보박스에 없는 값을 필드에 저장시키면 연결이 안된것처럼 화면에 출력  -->
            ...
            <td>직업을 선택 하세요.</td>
          		<script>
					document.regForm.mem_job.value="<%=mem.getMem_job().trim()%>";		  
				  </script>
          </tr>
          <tr> 
            <td colspan="3" align="center"> 
             <input type="button" value="수정하기"   onclick="inputCheck()"> 
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
